...
ifeq ($(config),release32)
  OBJDIR     = build/x32/Release/zlib-example
  TARGETDIR  = bin
...
ifeq ($(config),debug32)
  OBJDIR     = build/x32/Debug/zlib-example
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/example.exe
...
ifeq ($(config),release64)
  OBJDIR     = build/x64/Release/zlib-example
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/example.exe
  DEFINES   += 
  INCLUDES  += -Izlib-1.2.8
...
ifeq ($(config),debug64)
  OBJDIR     = build/x64/Debug/zlib-example
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/example.exe
  DEFINES   += -D_DEBUG -DDEBUG
  INCLUDES  += -Izlib-1.2.8
...
$(OBJDIR)/example.o: zlib-1.2.8/test/example.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
