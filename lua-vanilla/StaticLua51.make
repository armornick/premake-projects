...
ifeq ($(config),release32)
  OBJDIR     = build/x32/Release/StaticLua51
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/liblua51.a
  DEFINES   += 
  INCLUDES  += 
...
ifeq ($(config),debug32)
  OBJDIR     = build/x32/Debug/StaticLua51
  TARGETDIR  = bin/debug
  TARGET     = $(TARGETDIR)/liblua51.a
...
ifeq ($(config),release64)
  OBJDIR     = build/x64/Release/StaticLua51
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/liblua51.a
  DEFINES   += 
  INCLUDES  += 
...
ifeq ($(config),debug64)
  OBJDIR     = build/x64/Debug/StaticLua51
  TARGETDIR  = bin/debug
  TARGET     = $(TARGETDIR)/liblua51.a
  DEFINES   += -D_DEBUG -DDEBUG
  INCLUDES  += 
