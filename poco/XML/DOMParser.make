...
ifeq ($(config),release32)
  OBJDIR     = ../build/x32/Release/DOMParser
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/DOMParser.exe
...
ifeq ($(config),debug32)
  OBJDIR     = ../build/x32/Debug/DOMParser
  TARGETDIR  = ../bin/debug
  TARGET     = $(TARGETDIR)/DOMParser.exe
...
ifeq ($(config),release64)
  OBJDIR     = ../build/x64/Release/DOMParser
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/DOMParser.exe
  DEFINES   += -DNDEBUG -D_WIN32 -DWINVER=0x500 -DPOCO_NO_FPENVIRONMENT -DPCRE_STATIC -DPOCO_THREAD_STACK_SIZE -DFoundation_Config_INCLUDED -DMINGW32
  INCLUDES  += -I../Foundation/include -Iinclude
...
ifeq ($(config),debug64)
  OBJDIR     = ../build/x64/Debug/DOMParser
  TARGETDIR  = ../bin/debug
  TARGET     = $(TARGETDIR)/DOMParser.exe
  DEFINES   += -D_DEBUG -DDEBUG -D_WIN32 -DWINVER=0x500 -DPOCO_NO_FPENVIRONMENT -DPCRE_STATIC -DPOCO_THREAD_STACK_SIZE -DFoundation_Config_INCLUDED -DMINGW32
  INCLUDES  += -I../Foundation/include -Iinclude
...
$(OBJDIR)/DOMParser.o: samples/DOMParser/src/DOMParser.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
