...
ifeq ($(config),release32)
  OBJDIR     = ../build/x32/Release/dict
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/dict.exe
...
$(OBJDIR)/dict.o: samples/dict/src/dict.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
