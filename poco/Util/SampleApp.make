...
ifeq ($(config),release32)
  OBJDIR     = ../build/x32/Release/SampleApp
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/SampleApp.exe
...
ifeq ($(config),debug32)
  OBJDIR     = ../build/x32/Debug/SampleApp
  TARGETDIR  = ../bin/debug
  TARGET     = $(TARGETDIR)/SampleApp.exe
...
ifeq ($(config),release64)
  OBJDIR     = ../build/x64/Release/SampleApp
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/SampleApp.exe
  DEFINES   += -DNDEBUG -D_WIN32 -DWINVER=0x500 -DPOCO_NO_FPENVIRONMENT -DPCRE_STATIC -DPOCO_THREAD_STACK_SIZE -DFoundation_Config_INCLUDED -DMINGW32
  INCLUDES  += -I../Foundation/include -Iinclude -I../XML/include
...
ifeq ($(config),debug64)
  OBJDIR     = ../build/x64/Debug/SampleApp
  TARGETDIR  = ../bin/debug
  TARGET     = $(TARGETDIR)/SampleApp.exe
  DEFINES   += -D_DEBUG -DDEBUG -D_WIN32 -DWINVER=0x500 -DPOCO_NO_FPENVIRONMENT -DPCRE_STATIC -DPOCO_THREAD_STACK_SIZE -DFoundation_Config_INCLUDED -DMINGW32
  INCLUDES  += -I../Foundation/include -Iinclude -I../XML/include
...
$(OBJDIR)/SampleApp.o: samples/SampleApp/src/SampleApp.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
