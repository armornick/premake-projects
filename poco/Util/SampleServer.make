...
ifeq ($(config),release32)
  OBJDIR     = ../build/x32/Release/SampleServer
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/SampleServer.exe
...
ifeq ($(config),debug32)
  OBJDIR     = ../build/x32/Debug/SampleServer
  TARGETDIR  = ../bin/debug
  TARGET     = $(TARGETDIR)/SampleServer.exe
...
ifeq ($(config),release64)
  OBJDIR     = ../build/x64/Release/SampleServer
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/SampleServer.exe
  DEFINES   += -DNDEBUG -D_WIN32 -DWINVER=0x500 -DPOCO_NO_FPENVIRONMENT -DPCRE_STATIC -DPOCO_THREAD_STACK_SIZE -DFoundation_Config_INCLUDED -DMINGW32
  INCLUDES  += -I../Foundation/include -Iinclude -I../XML/include
...
ifeq ($(config),debug64)
  OBJDIR     = ../build/x64/Debug/SampleServer
  TARGETDIR  = ../bin/debug
  TARGET     = $(TARGETDIR)/SampleServer.exe
  DEFINES   += -D_DEBUG -DDEBUG -D_WIN32 -DWINVER=0x500 -DPOCO_NO_FPENVIRONMENT -DPCRE_STATIC -DPOCO_THREAD_STACK_SIZE -DFoundation_Config_INCLUDED -DMINGW32
  INCLUDES  += -I../Foundation/include -Iinclude -I../XML/include
...
$(OBJDIR)/SampleServer.o: samples/SampleServer/src/SampleServer.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
