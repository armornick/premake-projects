...
ifeq ($(config),release32)
  OBJDIR     = ../build/x32/Release/DateTime
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/DateTime.exe
...
ifeq ($(config),debug32)
  OBJDIR     = ../build/x32/Debug/DateTime
  TARGETDIR  = ../bin/debug
  TARGET     = $(TARGETDIR)/DateTime.exe
...
ifeq ($(config),release64)
  OBJDIR     = ../build/x64/Release/DateTime
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/DateTime.exe
  DEFINES   += -DNDEBUG -D_WIN32 -DWINVER=0x500 -DPOCO_NO_FPENVIRONMENT -DPCRE_STATIC -DPOCO_THREAD_STACK_SIZE -DFoundation_Config_INCLUDED -DMINGW32
  INCLUDES  += -Iinclude
...
ifeq ($(config),debug64)
  OBJDIR     = ../build/x64/Debug/DateTime
  TARGETDIR  = ../bin/debug
  TARGET     = $(TARGETDIR)/DateTime.exe
  DEFINES   += -D_DEBUG -DDEBUG -D_WIN32 -DWINVER=0x500 -DPOCO_NO_FPENVIRONMENT -DPCRE_STATIC -DPOCO_THREAD_STACK_SIZE -DFoundation_Config_INCLUDED -DMINGW32
  INCLUDES  += -Iinclude
...
$(OBJDIR)/DateTime.o: samples/DateTime/src/DateTime.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
