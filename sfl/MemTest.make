...
ifeq ($(config),release32)
  OBJDIR     = build/x32/Release/MemTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/MemTest.exe
  DEFINES   += 
  INCLUDES  += 
...
ifeq ($(config),debug32)
  OBJDIR     = build/x32/Debug/MemTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/MemTest.exe
...
ifeq ($(config),release64)
  OBJDIR     = build/x64/Release/MemTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/MemTest.exe
  DEFINES   += 
  INCLUDES  += 
...
ifeq ($(config),debug64)
  OBJDIR     = build/x64/Debug/MemTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/MemTest.exe
  DEFINES   += -D_DEBUG -DDEBUG
  INCLUDES  += 
...
$(OBJDIR)/testmem.o: sflsrc21/testmem.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
