...
ifeq ($(config),release32)
  OBJDIR     = build/x32/Release/DirTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/DirTest.exe
  DEFINES   += 
  INCLUDES  += 
...
ifeq ($(config),debug32)
  OBJDIR     = build/x32/Debug/DirTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/DirTest.exe
...
ifeq ($(config),release64)
  OBJDIR     = build/x64/Release/DirTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/DirTest.exe
  DEFINES   += 
  INCLUDES  += 
...
ifeq ($(config),debug64)
  OBJDIR     = build/x64/Debug/DirTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/DirTest.exe
  DEFINES   += -D_DEBUG -DDEBUG
  INCLUDES  += 
...
$(OBJDIR)/testdir.o: sflsrc21/testdir.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
