...
ifeq ($(config),release32)
  OBJDIR     = build/x32/Release/DateTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/DateTest.exe
  DEFINES   += 
  INCLUDES  += 
...
ifeq ($(config),debug32)
  OBJDIR     = build/x32/Debug/DateTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/DateTest.exe
...
ifeq ($(config),release64)
  OBJDIR     = build/x64/Release/DateTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/DateTest.exe
  DEFINES   += 
  INCLUDES  += 
...
ifeq ($(config),debug64)
  OBJDIR     = build/x64/Debug/DateTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/DateTest.exe
  DEFINES   += -D_DEBUG -DDEBUG
  INCLUDES  += 
...
$(OBJDIR)/testdate.o: sflsrc21/testdate.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
