...
ifeq ($(config),release32)
  OBJDIR     = build/x32/Release/BitTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/BitTest.exe
  DEFINES   += 
  INCLUDES  += 
...
ifeq ($(config),debug32)
  OBJDIR     = build/x32/Debug/BitTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/BitTest.exe
...
ifeq ($(config),release64)
  OBJDIR     = build/x64/Release/BitTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/BitTest.exe
  DEFINES   += 
  INCLUDES  += 
...
ifeq ($(config),debug64)
  OBJDIR     = build/x64/Debug/BitTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/BitTest.exe
  DEFINES   += -D_DEBUG -DDEBUG
  INCLUDES  += 
...
$(OBJDIR)/testbits.o: sflsrc21/testbits.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
