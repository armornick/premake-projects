...
ifeq ($(config),release32)
  OBJDIR     = build/x32/Release/CryptTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/CryptTest.exe
  DEFINES   += 
  INCLUDES  += 
...
ifeq ($(config),debug32)
  OBJDIR     = build/x32/Debug/CryptTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/CryptTest.exe
...
ifeq ($(config),release64)
  OBJDIR     = build/x64/Release/CryptTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/CryptTest.exe
  DEFINES   += 
  INCLUDES  += 
...
ifeq ($(config),debug64)
  OBJDIR     = build/x64/Debug/CryptTest
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/CryptTest.exe
  DEFINES   += -D_DEBUG -DDEBUG
  INCLUDES  += 
...
$(OBJDIR)/testcryp.o: sflsrc21/testcryp.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
